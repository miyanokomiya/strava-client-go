 ...
 * @param "PhotoIds" (optional.Interface of map[string]interface{}) -  List of native photo ids to attach to the activity.
...
*/
func (a *ActivitiesApiService) GetKudoersByActivityId(ctx _context.Context, id int32, localVarOptionals *GetKudoersByActivityIdOpts) ([]SummaryAthlete, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
