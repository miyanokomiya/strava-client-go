...
// GetLeaderboardBySegmentIdOpts Optional parameters for the method 'GetLeaderboardBySegmentId'
...
*/
func (a *SegmentsApiService) GetLeaderboardBySegmentId(ctx _context.Context, id int64, localVarOptionals *GetLeaderboardBySegmentIdOpts) (SegmentLeaderboard, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
